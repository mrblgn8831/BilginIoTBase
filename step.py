...
### Adımlar
# 1. Kaynak ve hedefi al   2.Hedef şehrin bağlı olduğu bayiyi bul    3.Bayi stok durumunu kontrol et
# 4. Bayı stoğu yetersiz ise depo stoğunu kontrol et     5. Tahmini 
#
#uskx = 41.22551
#usky = 29.0207
#nisx = 41.041813
...
try:
    ...
    print(e)
# Rotayı Al
seql1 = "select * from rota where idx=35"
curs1 = conx.cursor()
curs1.execute(seql1)
res1 = curs1.fetchall()
for rotan in res1:
